...
#This initial code will set up the large date file and pedigree file used in later analysis
library(tidyverse)
library(caret)
...
#This code counts the number of RSIDs that are homozygous identical among all of the individuas in the large data file.
...
#write.csv(results, 'saved_results')
